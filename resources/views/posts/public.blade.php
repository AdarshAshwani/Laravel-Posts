...
<div class="max-w-3xl mx-auto mb-3 flex items-center justify-end">
    <button id="themeToggle" class="text-xs px-3 py-1.5 rounded-lg border bg-white/80 hover:bg-white
    ...
    <article class="soft-card soft-card-hover spotlight p-5">
        <header class="flex items-start gap-3">
            ...
            <div class="flex-1">
                ...
                @if($post->description)
                <div class="mt-2 text-slate-200 dark:text-slate-800 leading-7">
        ...
        <footer
            ...
            <button type="button" class="btn-ghost text-sm share-btn" data-url="{{ route('posts.show', $post->slug) }}">
                Share
            </button>
        </footer>
    </article>
